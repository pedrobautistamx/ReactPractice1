...
const CallContainer = props => <Async load={import('Containers/CallClient/CallContainer')} componentProps={props} />
...
const Application = (props) => (
	<App {...props} >
        ...
        <Route path={`${props.match.url}/CallContainer`} component={CallContainer} />
	</App>)
